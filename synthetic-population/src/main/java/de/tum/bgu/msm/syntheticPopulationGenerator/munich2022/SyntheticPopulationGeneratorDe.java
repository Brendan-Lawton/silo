...
import de.tum.bgu.msm.syntheticPopulationGenerator.properties.Munich2022PropertiesSynPop;
...
public class SyntheticPopulationGeneratorDe {
    ...
    public static void main (String[] args) {
        ...
        try {
            PropertiesSynPop.initializePropertiesSynPop(new Munich2022PropertiesSynPop(new PropertyResourceBundle(new FileReader(args[0]))));
