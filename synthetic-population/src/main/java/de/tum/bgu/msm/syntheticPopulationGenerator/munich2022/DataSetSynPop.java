...
public class DataSetSynPop {
    ...
    private Map<Integer, Map<MunichDwellingTypes.DwellingTypeMunich, Integer>> dwellingPriceByTypeAndZone;
    ...
    public Map<Integer, Map<MunichDwellingTypes.DwellingTypeMunich, Integer>> getDwellingPriceByTypeAndZone() {
        return dwellingPriceByTypeAndZone;
    }

    public void setDwellingPriceByTypeAndZone(Map<Integer, Map<MunichDwellingTypes.DwellingTypeMunich, Integer>> dwellingPriceByTypeAndZone) {
